...
<div class="box box-primary">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    {!! Form::select('role_user', ['' => 'Please Select'] + $roles, $user->roles()->first() != null?$user->roles()->first()->id:NULL, ['class' => 'form-control select2', 'placeholder' => 'Enter parent_id'])  !!}
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    {!! Form::label('parent_id', 'Parent:', ['class' => 'control-label']) !!}
                    {!! Form::select('parent_id', ['' => 'Please Select'] + $users, $user->parent_id, ['class' => 'form-control select2', 'placeholder' => 'Enter parent_id'])  !!}
                </div>
    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    {!! Form::label('is_exchange', 'Can payment?:', ['class' => 'control-label']) !!}
                    {!! Form::select('is_exchange', ['1' => 'Yes','0' => 'No'], $user->is_exchange, ['class' => 'form-control select2', 'placeholder' => 'Enter is_exchange'])  !!}
                </div>
